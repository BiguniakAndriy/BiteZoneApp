...
Для того щоб почати тестувати додаток Bite Zone, вам потрібно виконати кілька простих кроків:


## 1.Встановити TestFlight
...
## 2. Відкрити посилання
Відкрийте на своєму iOS-пристрої публічне посилання на тестову версію додатку, яку ви отримали від розробника. В результаті ви будете перенаправлені до TestFlight.

![Відкрийте посилання](resources/testing/open-url.PNG)


## 3. Інсталювати Bite Zone 
Після переходу за посиланням в додатку TestFlight з'явиться вікно з інформацією про додаток Bite Zone, де потрібно натиснути кнопку «Інсталювати». Також варто звернути увагу на розділ «Що тестувати», де вказана додаткова інформація від розробника.
...
Якщо ви виявили помилку або щось працює так так як очікується, ось як правильно повідомити про баг:
...
- **Скріншоти або відео**: Прикріпіть скріншоти або запис екрану, якщо це можливо
- **Частота появи**: Помилка з'являється завжди (при відтворені описаних кроків) або інколи
